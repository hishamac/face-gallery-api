...
def delete_album(album_id):
    ...
    try:
        ...
        if image_count > 0:
            return jsonify({
                "error": f"Cannot delete album. It contains {image_count} images. Please move or delete the images first."
            }), 400
...
def delete_section(section_id):
    ...
    try:
        ...
        if image_count > 0:
            return jsonify({
                "error": f"Cannot delete section. It contains {image_count} images. Please move or delete the images first."
            }), 400
